        ...
        queryFn: async () => {
            ...
            return {
                ...
                questions: (questions || []).map((q) => ({
                    ...
                    // Preserve empty strings — `|| undefined` broke fill-blank / code-runner when admins left "" in the DB.
                    code: q.code == null ? undefined : q.code,
                    answer: q.answer == null ? undefined : q.answer,
                    options: q.options,
                    blocks: q.blocks,
                    correct_order: q.correct_order,
                    hint: q.hint == null ? undefined : q.hint,
                    initial_code: q.initial_code == null ? undefined : q.initial_code,
                    expected_output: q.expected_output == null ? undefined : q.expected_output,
