import {
  Trophy, Star, Flame, BookOpen, Users, Swords, Target, Medal, Award, Gem, Crown, Zap, GraduationCap, Lock
} from
  "lucide-react";
...
export function AchievementCard({
  ...
  return (
    <div
      className={cn("p-4 bg-card rounded-2xl border border-border card-elevated",

        !isEarned && "border-dashed text-muted-foreground"
      )}>
