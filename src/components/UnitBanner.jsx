...
export function UnitBanner({ title, description, color, isActive = false, currentLessonId, unitId, completedLessons = 0, totalLessons = 0 }) {
    return <div className={cn("relative overflow-hidden rounded-xl sm:rounded-2xl p-4 sm:p-6 bg-gradient-to-r", colorClasses[color])}>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-nowrap items-center gap-2 shrink-0">
          ...
          {isActive && currentLessonId && (<Button variant="golden" size="sm" className="shadow-none shrink-0" asChild>
