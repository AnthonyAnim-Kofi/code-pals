...
export function ProductTour() {
    ...
    if (isLoading || !profile || !run)
        return null;
    const steps = isMobile ? MOBILE_STEPS : DESKTOP_STEPS;
    return (<Joyride steps={steps} run={run} continuous showSkipButton showProgress scrollToFirstStep={false} disableScrolling disableOverlayClose callback={handleCallback} locale={{
            back: "Back",
            close: "Close",
            last: "Finish",
            next: "Next",
