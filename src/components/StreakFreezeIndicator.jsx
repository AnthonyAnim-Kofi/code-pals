...
export function StreakFreezeIndicator({ freezeCount, lastUsed, className }) {
    ...
    return (<div className={cn("p-4 bg-card rounded-2xl border border-border card-elevated", className)}>
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-0.5">
              {[...Array(3)].map((_, i) => (<div key={i} className={cn("w-2 h-2 rounded-full", i < freezeCount ? "bg-secondary" : "bg-muted")}/>))}
            </div>
          </div>
