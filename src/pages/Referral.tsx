    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-card rounded-2xl border border-border card-elevated space-y-4">
        <div className="flex items-center gap-2">
          <Gem className="w-5 h-5 text-golden" />
          <span className="font-bold text-foreground">Total gems from referrals</span>
        </div>
        <p className="text-3xl font-extrabold text-golden">{totalGemsEarned}</p>
        ...
        {referralCode ? (
          <>
            ...
            <p className="text-sm text-muted-foreground">
              You and your friend each get <span className="font-semibold text-golden">50 gems</span> when they sign up with your link and finish onboarding.
            </p>
            ...
            {referrals.map((r) => (
              ...
              >
                ...
                <span className="text-sm text-muted-foreground">
                  ...
                  · <span className="text-golden font-semibold">+{r.gems_awarded} gems</span>
                </span>
              </li>
            ))}
          </ul>
