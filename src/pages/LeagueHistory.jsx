...
export default function LeagueHistory() {
    ...
    return (<div className="space-y-6">
      ...
      {history.length === 0 ?
          ...
          {history.map((entry) => <div key={entry.id} className={cn("p-4 rounded-2xl border border-border bg-card card-elevated", entry.action === "promoted" && "border-l-4 border-l-primary", entry.action === "demoted" && "border-l-4 border-l-destructive")}>
          
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className={cn("w-12 h-12 rounded-full flex items-center justify-center", entry.action === "promoted" ?
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className={cn("px-2 py-0.5 rounded-full text-xs uppercase font-extrabold", entry.action === "promoted" ?
                        "bg-primary/10 text-primary" :
                        "bg-destructive/10 text-destructive")}>
                ...
                <div className="text-right">
                  <p className="text-lg text-golden font-extrabold">{entry.weekly_xp} XP</p>
